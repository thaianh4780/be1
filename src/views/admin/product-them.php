                ...
                <div class="col">
                    <div class="card shadow mb-3">
                        <div class="card-body">
                            ...
                            <form action="<?php echo BASE_URL . '/check-add-product' ?>" method="POST">
                                <div class="form-row">
                                    <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="product_last_update" name="status">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="cate_name" name="c_id">
                                </div>
                                <div class="form-group">
                                    <label for="product_name">
                                        <strong>p_id</strong>
                                    </label>
                                    <input class="form-control" type="text" id="cate_name" name="p_id">
                                </div>
                        </div>
                        <div class="form-group">
